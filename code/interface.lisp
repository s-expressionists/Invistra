...
(trinsic:make-define-interface (:client-form client-form :intrinsic intrinsicp)
  ...
  `((defun ,format-sym (destination control-string &rest args)
    ...
    (define-compiler-macro ,break-sym (&whole form &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1))

    (define-compiler-macro ,cerror-sym (&whole form &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1 2))

    (define-compiler-macro ,error-sym (&whole form  &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1))
    ...
    (define-compiler-macro ,signal-sym (&whole form &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1))

    (define-compiler-macro ,warn-sym (&whole form &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1))

    (define-compiler-macro ,y-or-n-p-sym (&whole form &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1))

    (define-compiler-macro ,yes-or-no-p-sym (&whole form &rest args)
      (declare (ignore args))
      (expand-function ,client-form form 1))))
